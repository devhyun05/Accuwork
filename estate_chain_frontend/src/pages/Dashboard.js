              ...
              <div className="bg-white rounded-lg shadow-md p-8 w-full max-w-xl">
                <div>
                  <div class="text-center">
                    <button
                      class="w-1/2 bg-blue-600 text-white font-bold py-2 px-4 rounded-l transition duration-300 ease-in-out hover:bg-blue-700 hover:text-gray-100 focus:outline-none focus:bg-blue-700 focus:border-blue-500 focus:shadow-outline-blue focus:text-black"
